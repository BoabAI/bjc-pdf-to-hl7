...
| `SMEC-AI-BJC-PAD-Weekly-Restart.xml` | Task Scheduler definition — Saturday **03:07**, `BJC\medihost`, highest privileges, run only when logged on, 15-min limit, catch-up if missed. |
