...
const SCENARIOS: Scenario[] = [
  {
    kind: "pathology",
    filename: "result_pathology_chemistry.pdf",
  ...
  {
    kind: "pathology",
    filename: "result_pathology_microbiology.pdf",
  ...
  {
    kind: "radiology",
    filename: "result_radiology_mri.pdf",
  ...
  {
    kind: "radiology",
    filename: "result_radiology_ultrasound.pdf",
